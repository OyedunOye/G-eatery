...
const Footer = () => {
  ...
  <div className='app__footer section__padding' id='login'>
    ...
    {/* I still need to find out how to make overlay work with 
     this code. the whole return statement of footer is not 
    rendered as it is if I comment out FooterOverlay
    component. */}
    {/* <FooterOverlay /> */}
